...
@NoArgsConstructor
@AllArgsConstructor
public class FreeProductsReservationCommand implements DomainEvent {
    ...
    public FreeProductsReservationCommand(List<ProductReservation> productReservations) {
    ...
    @Override
    public String topic() {
        return TOPIC_FREE_PRODUCT_RESERVATIONS;
    }
